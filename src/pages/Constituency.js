...
function Constituency(props) {
  ...
  return (
    <>
      <PageTitle>{props.const_data.const_name} Constituency </PageTitle>
      {/* <CTA /> */}
      ...
      <div className="grid gap-6 mb-16 md:grid-cols-2 xl:grid-cols-5">
        <InfoCard
          ...
          value={props.const_data.registered_voters}
        >
          <RoundIcon
        ...
        <InfoCard title="Total Votes Cast" value={props.const_data.total_votes}>
          <RoundIcon
        ...
        <InfoCard
          ...
          value={props.const_data.spoiled_votes}
        >
          <RoundIcon
            icon={"fas fa-ban"}
            iconColorClass="text-orange-500 dark:text-orange-100"
      ...
      <div className="grid gap-6 mb-8 md:grid-cols-1">
        <ChartCard title="Aspirants">
          <Doughnut
            {...doughnutOptions([
              props.const_data.ahmed_ali_muktar,
              props.const_data.ahmed_abdullahi,
              props.const_data.abdullahi_ibrahim_ali,
              props.const_data.osman_warfa,
              props.const_data.siyat_abdullahi,
              props.const_data.ugas_sheikh_mohamed,
              props.const_data.mohamed_ibrahim_elmi,
              props.const_data.hassan_mohamed_adan,
              props.const_data.mohamed_abdi_mohamud,
            ])}
          />
        ...
        <Table>
          ...
          <TableBody>
            <TableRow>
              ...
              <TableCell>{props.const_data.ahmed_ali_muktar}</TableCell>
              <TableCell>
                {(
                  (props.const_data.ahmed_ali_muktar /
                    props.const_data.total_votes) *
                  100
                ).toFixed(2)}
              </TableCell>
            </TableRow>
            <TableRow>
              ...
              <TableCell>{props.const_data.ahmed_abdullahi}</TableCell>
              <TableCell>
                {(
                  (props.const_data.ahmed_abdullahi /
                    props.const_data.total_votes) *
            ...
            <TableRow>
              ...
              <TableCell>{props.const_data.abdullahi_ibrahim_ali}</TableCell>
              <TableCell>
                {(
                  (props.const_data.abdullahi_ibrahim_ali /
                    props.const_data.total_votes) *
            ...
            <TableRow>
              ...
              <TableCell>{props.const_data.osman_warfa}</TableCell>
              <TableCell>
                {(
                  (props.const_data.osman_warfa /
                    props.const_data.total_votes) *
            ...
            <TableRow>
              ...
              <TableCell>{props.const_data.siyat_abdullahi}</TableCell>
              <TableCell>
                {(
                  (props.const_data.siyat_abdullahi /
                    props.const_data.total_votes) *
            ...
            <TableRow>
              ...
              <TableCell>{props.const_data.ugas_sheikh_mohamed}</TableCell>
              <TableCell>
                {(
                  (props.const_data.ugas_sheikh_mohamed /
                    props.const_data.total_votes) *
            ...
            <TableRow>
              ...
              <TableCell>{props.const_data.mohamed_ibrahim_elmi}</TableCell>
              <TableCell>
                {(
                  (props.const_data.mohamed_ibrahim_elmi /
                    props.const_data.total_votes) *
            ...
            <TableRow>
              ...
              <TableCell>{props.const_data.hassan_mohamed_adan}</TableCell>
              <TableCell>
                {(
                  (props.const_data.hassan_mohamed_adan /
                    props.const_data.total_votes) *
            ...
            <TableRow>
              ...
              <TableCell>INDEPENDENT</TableCell>
              <TableCell>{props.const_data.mohamed_abdi_mohamud}</TableCell>
              <TableCell>
                {(
                  (props.const_data.mohamed_abdi_mohamud /
                    props.const_data.total_votes) *
