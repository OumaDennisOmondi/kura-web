...
function Ward(props) {
  ...
  return (
    <>
      <PageTitle>{props.caw_data.caw_name} Ward </PageTitle>
      {/* <CTA /> */}
      ...
      <div className="grid gap-6 mb-16 md:grid-cols-2 xl:grid-cols-5">
        <InfoCard
          ...
          value={props.caw_data.registered_voters}
        >
          <RoundIcon
        ...
        <InfoCard title="Total Votes Cast" value={props.caw_data.total_votes}>
          <RoundIcon
        ...
        <InfoCard
          ...
          value={props.caw_data.spoiled_votes}
        >
          <RoundIcon
            icon={"fas fa-ban"}
            iconColorClass="text-orange-500 dark:text-orange-100"
      ...
      <div className="grid gap-6 mb-8 md:grid-cols-1">
        <ChartCard title="Aspirants">
          <Doughnut
            {...doughnutOptions([
              props.caw_data.ahmed_ali_muktar,
              props.caw_data.ahmed_abdullahi,
              props.caw_data.abdullahi_ibrahim_ali,
              props.caw_data.osman_warfa,
              props.caw_data.siyat_abdullahi,
              props.caw_data.ugas_sheikh_mohamed,
              props.caw_data.mohamed_ibrahim_elmi,
              props.caw_data.hassan_mohamed_adan,
              props.caw_data.mohamed_abdi_mohamud,
            ])}
          />
        ...
        <Table>
          ...
          <TableBody>
            <TableRow>
              ...
              <TableCell>{props.caw_data.ahmed_ali_muktar}</TableCell>
              <TableCell>
                {(
                  (props.caw_data.ahmed_ali_muktar /
                    props.caw_data.total_votes) *
                  100
                ).toFixed(2)}
              </TableCell>
            </TableRow>
            <TableRow>
              ...
              <TableCell>{props.caw_data.ahmed_abdullahi}</TableCell>
              <TableCell>
                {(
                  (props.caw_data.ahmed_abdullahi /
                    props.caw_data.total_votes) *
            ...
            <TableRow>
              ...
              <TableCell>{props.caw_data.abdullahi_ibrahim_ali}</TableCell>
              <TableCell>
                {(
                  (props.caw_data.abdullahi_ibrahim_ali /
                    props.caw_data.total_votes) *
            ...
            <TableRow>
              ...
              <TableCell>{props.caw_data.osman_warfa}</TableCell>
              <TableCell>
                {(
                  (props.caw_data.osman_warfa / props.caw_data.total_votes) *
                  100
                ).toFixed(2)}
              </TableCell>
            </TableRow>
            <TableRow>
              ...
              <TableCell>{props.caw_data.siyat_abdullahi}</TableCell>
              <TableCell>
                {(
                  (props.caw_data.siyat_abdullahi /
                    props.caw_data.total_votes) *
            ...
            <TableRow>
              ...
              <TableCell>{props.caw_data.ugas_sheikh_mohamed}</TableCell>
              <TableCell>
                {(
                  (props.caw_data.ugas_sheikh_mohamed /
                    props.caw_data.total_votes) *
            ...
            <TableRow>
              ...
              <TableCell>{props.caw_data.mohamed_ibrahim_elmi}</TableCell>
              <TableCell>
                {(
                  (props.caw_data.mohamed_ibrahim_elmi /
                    props.caw_data.total_votes) *
            ...
            <TableRow>
              ...
              <TableCell>{props.caw_data.hassan_mohamed_adan}</TableCell>
              <TableCell>
                {(
                  (props.caw_data.hassan_mohamed_adan /
                    props.caw_data.total_votes) *
            ...
            <TableRow>
              ...
              <TableCell>INDEPENDENT</TableCell>
              <TableCell>{props.caw_data.mohamed_abdi_mohamud}</TableCell>
              <TableCell>
                {(
                  (props.caw_data.mohamed_abdi_mohamud /
                    props.caw_data.total_votes) *
