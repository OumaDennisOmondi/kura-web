...
export const WARDS = BASE_URL + "wards";

export const REGISTRATION_CENTRES = BASE_URL + "registration-centre";

export const POLLING_STATIONS = BASE_URL + "polling-stations";

 export const ASPIRANTS_URL = BASE_URL + "people"

export const TARGETS_URL = "CONSTITUENCIES_"

export const EXPERIMENTS_URL = BASE_URL + "experiment";

export const AUTH_URL = BASE_URL + "auth";

export const AWS_CONFIG = BASE_URL + "aws";
